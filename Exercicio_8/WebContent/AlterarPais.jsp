                    ...
                    <form action="ManterCliente.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="popu" id="popu" required maxlength="100" placeholder="nome completo" value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">Area</label>
                                <input type="text" class="form-control" name="area" id="area" required maxlength="60" placeholder="email obrigatório" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
